...
# Fitur: Enkripsi, Dekripsi + Detail Proses + Tombol Bersihkan
...
def bersihkan():
    ...
    messagebox.showinfo("Info", "Semua kolom telah dibersihkan!")
...
# Tombol Bersihkan ditambahkan di bawah tombol enkripsi/dekripsi
btn_clear = ttk.Button(frame_button, text="🧹 Bersihkan", command=bersihkan)
